...
public class EmployeeService {
    ...
    /*按照查询条件分页查询员工信息记录*/
    public ArrayList<Employee> queryEmployee(String employeeNo,String name,String department,String birthDate,int currentPage) throws Exception { 
    	...
    	if(!department.equals("")) where = where + " and t_employee.department like '%" + department + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Employee> queryEmployee(String employeeNo,String name,String department,String birthDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!employeeNo.equals("")) where = where + " and t_employee.employeeNo like '%" + employeeNo + "%'";
    	if(!name.equals("")) where = where + " and t_employee.name like '%" + name + "%'";
    	if(!department.equals("")) where = where + " and t_employee.department like '%" + department + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String employeeNo,String name,String department,String birthDate) throws Exception {
     	String where = "where 1=1";
    	if(!employeeNo.equals("")) where = where + " and t_employee.employeeNo like '%" + employeeNo + "%'";
    	if(!name.equals("")) where = where + " and t_employee.name like '%" + name + "%'";
    	if(!department.equals("")) where = where + " and t_employee.department like '%" + department + "%'";
