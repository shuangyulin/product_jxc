		       ...
		       text: "进货信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Purchase/purchase_add.jsp"
			    	   	},
			    		{
			    	   		text: "进货信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Purchase/purchase_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "销售信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Sale/sale_add.jsp"
			    	   	},
			    		{
			    	   		text: "销售信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Sale/sale_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "会员信息管理",
		       ...
		       text: "供应商管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Supplier/supplier_add.jsp"
			    	   	},
			    		{
			    	   		text: "供应商管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Supplier/supplier_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
