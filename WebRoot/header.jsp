    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Attendance/frontlist">员工出勤</a></li>
                <li><a href="<%=basePath %>Salary/frontlist">员工工资</a></li>
                <li><a href="<%=basePath %>Purchase/frontlist">进货信息</a></li>
                <li><a href="<%=basePath %>Sale/frontlist">销售信息</a></li>
                <li><a href="<%=basePath %>UserInfo/frontlist">会员信息</a></li>
                <li><a href="<%=basePath %>Supplier/frontlist">供应商</a></li>
