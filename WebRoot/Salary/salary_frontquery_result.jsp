				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>工资id</td><td>员工</td><td>年份</td><td>月份</td><td>考勤扣除</td><td>保险扣除</td><td>工资金额</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=salary.getAttendanceMoney() %></td>
 											<td><%=salary.getSecureMoney() %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="salary_year_edit" class="col-md-3 text-right">年份:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_year_edit" name="salary.year" class="form-control" placeholder="请输入年份">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_month_edit" class="col-md-3 text-right">月份:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_month_edit" name="salary.month" class="form-control" placeholder="请输入月份">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_attendanceMoney_edit" class="col-md-3 text-right">考勤扣除:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_attendanceMoney_edit" name="salary.attendanceMoney" class="form-control" placeholder="请输入考勤扣除">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="salary_secureMoney_edit" class="col-md-3 text-right">保险扣除:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="salary_secureMoney_edit" name="salary.secureMoney" class="form-control" placeholder="请输入保险扣除">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (salary, response, status) {
			if (salary) {
				...
				$("#salary_attendanceMoney_edit").val(salary.attendanceMoney);
				$("#salary_secureMoney_edit").val(salary.secureMoney);
