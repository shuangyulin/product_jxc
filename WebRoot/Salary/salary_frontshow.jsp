...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考勤扣除:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getAttendanceMoney()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">保险扣除:</div>
		<div class="col-md-10 col-xs-6"><%=salary.getSecureMoney()%></div>
	</div>
	<div class="row bottom15"> 
