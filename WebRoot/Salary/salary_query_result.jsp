...
<div id="salaryEditDiv">
	<form id="salaryEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">考勤扣除:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_attendanceMoney_edit" name="salary.attendanceMoney" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_secureMoney_edit" name="salary.secureMoney" style="width:80px" />
