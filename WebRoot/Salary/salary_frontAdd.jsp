		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>Salary/frontlist">员工工资列表</a></li>
			    	<li role="presentation" class="active"><a href="#salaryAdd" aria-controls="salaryAdd" role="tab" data-toggle="tab">添加员工工资</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="salaryAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="salary_year" class="col-md-2 text-right">年份:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="salary_year" name="salary.year" class="form-control" placeholder="请输入年份">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="salary_month" class="col-md-2 text-right">月份:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="salary_month" name="salary.month" class="form-control" placeholder="请输入月份">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="salary_attendanceMoney" class="col-md-2 text-right">考勤扣除:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="salary_attendanceMoney" name="salary.attendanceMoney" class="form-control" placeholder="请输入考勤扣除">
							 </div>
						  </div>
						  <div class="form-group">
						  	 <label for="salary_secureMoney" class="col-md-2 text-right">保险扣除:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="salary_secureMoney" name="salary.secureMoney" class="form-control" placeholder="请输入保险扣除">
							 </div>
						  </div>
						  <div class="form-group">
