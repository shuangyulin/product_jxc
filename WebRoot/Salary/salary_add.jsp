...
<div id="salaryAddDiv">
	<form id="salaryAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_attendanceMoney" name="salary.attendanceMoney" style="width:80px" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="salary_secureMoney" name="salary.secureMoney" style="width:80px" />
