				...
				$.ajax({
					...
					success : function (salary, response, status) {
						...
						if (salary) { 
							...
							$("#salary_attendanceMoney_edit").validatebox({
								required : true,
								validType : "number",
								missingMessage : "请输入考勤扣除",
								invalidMessage : "考勤扣除输入不对",
							});
							$("#salary_secureMoney_edit").val(salary.secureMoney);
							$("#salary_secureMoney_edit").validatebox({
								required : true,
								validType : "number",
								missingMessage : "请输入保险扣除",
								invalidMessage : "保险扣除输入不对",
							});
