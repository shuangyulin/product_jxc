...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>UserInfo/frontlist">会员信息信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">会员全称:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">联系人:</div>
		<div class="col-md-10 col-xs-6"><%=userInfo.getLegalMan()%></div>
	</div>
	<div class="row bottom15"> 
