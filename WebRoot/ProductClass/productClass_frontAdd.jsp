				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="productClassAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="productClass_productClassName" class="col-md-2 text-right">商品类别名称:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="productClass_productClassName" name="productClass.productClassName" class="form-control" placeholder="请输入商品类别名称">
							 </div>
						  </div>
				          <div class="form-group">
