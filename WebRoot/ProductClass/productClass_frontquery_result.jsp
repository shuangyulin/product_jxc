		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>ProductClass/productClass_frontAdd.jsp" style="display:none;">添加商品类别</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>商品类别id</td><td>商品类别名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<productClassList.size();i++) {
					    	            		...
					    	            		ProductClass productClass = productClassList.get(i); //获取到商品类别对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="productClass_productClassId_edit" class="col-md-3 text-right">商品类别id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="productClass_productClassId_edit" name="productClass.productClassId" class="form-control" placeholder="请输入商品类别id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="productClass_productClassName_edit" class="col-md-3 text-right">商品类别名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="productClass_productClassName_edit" name="productClass.productClassName" class="form-control" placeholder="请输入商品类别名称">
			 </div>
		  </div>
		</form> 
