...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Employee/frontlist">员工信息信息</a></li>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="<%=basePath %><%=employee.getPhoto() %>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">所在部门:</div>
		<div class="col-md-10 col-xs-6"><%=employee.getDepartment()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">联系地址:</div>
