...
<%
    ...
    String personName = (String)request.getAttribute("personName"); //联系人查询关键字
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>供应商id</td><td>供应商名称</td><td>联系人</td><td>联系电话</td><td>地址</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
